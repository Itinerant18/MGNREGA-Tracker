// MGNREGA Data Service with Real Government Data
// Source: Government of India MGNREGA MIS System FY 2025-26
...
class MGNREGADataService {
  constructor() {
    ...
    console.log('📊 Available districts:', Object.keys(MGNREGA_DISTRICTS_DATA['Andhra Pradesh']).length);
  }
